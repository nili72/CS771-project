...
from ldm.data.fake import  Dataset2Eval
...
def ldm_cond_sample_dataset(config_path, ckpt_path, dataset, batch_size):
    ...
    logdir='/ocean/projects/mat240020p/nli1/diffusion/samples/fake/images/'
    maskdir='/ocean/projects/mat240020p/nli1/diffusion/samples/fake/masks/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='/ocean/projects/mat240020p/nli1/diffusion/results/2024-12-06T00-23-02_256_unet3_32_augment/configs/2024-12-06T00-23-02-project.yaml')#2024-11-15T01-00-29-project.yaml')
    parser.add_argument('--ckpt_path', type=str, default='/ocean/projects/mat240020p/nli1/diffusion/results/2024-12-06T00-23-02_256_unet3_32_augment/checkpoints/epoch=000018.ckpt')
