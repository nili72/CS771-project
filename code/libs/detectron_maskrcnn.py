...
def get_config_file(input_yaml):
    ...
    if input_yaml['mask_on'] == True:
        if input_yaml['cascade_maskrcnn'] == True:
            ...
            cfg.merge_from_file("/jet/home/nliu3/cnn/figshare/MaskRCNNObjectDetection/code/train/detectron2_configs/configs/COCO-InstanceSegmentation/"+str(input_yaml['pretrained_model_name']))
