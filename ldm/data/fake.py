...
class Dataset2Eval(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv='/ocean/projects/mat240020p/nli1/diffusion/masks/masks.txt',
                         #'/jet/home/nli1/diffusion/loops/crops/val/val_256_crop_5_images.txt',#'data/kvasir/kvasir_eval.txt',
                         data_root='/ocean/projects/mat240020p/nli1/diffusion/masks/2024-12-01T02-10-22_256_batch_16_mask/',#'data/kvasir/images',
                         
                         segmentation_root='/ocean/projects/mat240020p/nli1/diffusion/masks/2024-12-01T02-10-22_256_batch_16_mask/',#'data/kvasir/masks',
                         size=size, random_crop=random_crop, interpolation=interpolation,
                         n_labels=4)
