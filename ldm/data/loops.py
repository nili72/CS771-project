...
class KvasirSegTrain(SegmentationBase): 
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"): 
        super().__init__(data_csv='/jet/home/nli1/diffusion/loops/crops/train/train_256_crop_5_images.txt',
                       data_root='/ocean/projects/mat240020p/nli1/diffusion/data/train/images/256_crop_5/',#'data/kvasir/images', 
                         segmentation_root='/jet/home/nli1/diffusion/loops/crops/train/masks/256_crop_5/',#'data/kvasir/masks', 
                         size=size, random_crop=random_crop, interpolation=interpolation, 
                         n_labels=4)
...
class KvasirSegEval(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv='/jet/home/nli1/diffusion/loops/crops/val/val_256_crop_5_images.txt',
                         #'/jet/home/nli1/diffusion/loops/crops/val/val_256_crop_5_images.txt',#'data/kvasir/kvasir_eval.txt',
                         data_root='/jet/home/nli1/diffusion/loops/crops/val/images/256_crop_5/',#'data/kvasir/images',
                         
                         segmentation_root='/jet/home/nli1/diffusion/loops/crops/val/masks/256_crop_5/',#'data/kvasir/masks',
                         size=size, random_crop=random_crop, interpolation=interpolation,
                         n_labels=4)
class Dataset2Train(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv='/ocean/projects/mat240020p/nli1/diffusion/data/dataset2/images/train/train_256_crop_5_images.txt',
                         #'/jet/home/nli1/diffusion/loops/crops/val/val_256_crop_5_images.txt',#'data/kvasir/kvasir_eval.txt',
                         data_root='/ocean/projects/mat240020p/nli1/diffusion/data/dataset2/images/train/256_crop_5/',#'data/kvasir/images',
                         
                         segmentation_root='/ocean/projects/mat240020p/nli1/diffusion/data/dataset2/masks/train/256_crop_5/',#'data/kvasir/masks',
                         size=size, random_crop=random_crop, interpolation=interpolation,
                         n_labels=4)
