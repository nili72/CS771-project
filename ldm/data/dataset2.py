...
class Dataset2Eval(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv='/ocean/projects/mat240020p/nli1/diffusion/data/dataset2/images/train/val_256_crop_5_0.5.txt',
                         #'/jet/home/nli1/diffusion/loops/crops/val/val_256_crop_5_images.txt',#'data/kvasir/kvasir_eval.txt',
                         data_root='/ocean/projects/mat240020p/nli1/diffusion/data/dataset2/images/train/256_crop_5-val/',#'data/kvasir/images',
...
class Dataset2Train(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv='/ocean/projects/mat240020p/nli1/diffusion/data/dataset2/images/train/train_256_crop_5_0.5.txt',
                         #'/jet/home/nli1/diffusion/loops/crops/val/val_256_crop_5_images.txt',#'data/kvasir/kvasir_eval.txt',
                         data_root='/ocean/projects/mat240020p/nli1/diffusion/data/dataset2/images/train/256_crop_5-train/',#'data/kvasir/images',
