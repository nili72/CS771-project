...
class KvasirSegTrain(SegmentationBase): 
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"): 
        super().__init__(data_csv='/ocean/projects/mat240020p/nli1/diffusion/data/train/train_512_crop_4_images.txt',
                         data_root='/ocean/projects/mat240020p/nli1/diffusion/data/train/images/512_crop_4/', 
                         #'/ocean/projects/mat240020p/nli1/diffusion/data/train/images/256_crop_5/',#'data/kvasir/images', 
                         segmentation_root='/ocean/projects/mat240020p/nli1/diffusion/data/train/masks/512_crop_4/', 
                         #'/jet/home/nli1/diffusion/loops/crops/train/masks/256_crop_5/',#'data/kvasir/masks', 
                         size=size, random_crop=random_crop, interpolation=interpolation, 
                         )
...
class KvasirSegEval(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv='/ocean/projects/mat240020p/nli1/diffusion/data/val/val_512_crop_4_images.txt',
                         #'/jet/home/nli1/diffusion/loops/crops/val/val_256_crop_5_images.txt',#'data/kvasir/kvasir_eval.txt',
                         data_root='/ocean/projects/mat240020p/nli1/diffusion/data/val/images/512_crop_4/',
                         #'/jet/home/nli1/diffusion/loops/crops/val/images/256_crop_5/',#'data/kvasir/images',
                         segmentation_root='/ocean/projects/mat240020p/nli1/diffusion/data/val/masks/512_crop_4/',
