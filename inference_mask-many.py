...
def ldm_cond_sample_dataset(config_path, ckpt_path, batch_size=4,n_sample=1000):
    ...
    logdir='/ocean/projects/mat240020p/nli1/diffusion/masks/2024-12-01T02-10-22_256_batch_16_mask/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='/ocean/projects/mat240020p/nli1/diffusion/results/2024-12-01T02-10-22_256_batch_16_mask/configs/2024-12-01T02-10-22-project.yaml')#2024-11-15T01-00-29-project.yaml')
    parser.add_argument('--ckpt_path', type=str, default='/ocean/projects/mat240020p/nli1/diffusion/results/2024-12-01T02-10-22_256_batch_16_mask/checkpoints/epoch=000016.ckpt')
    parser.add_argument('--batch_size', type=int, default=4)
    args = parser.parse_args()

    ldm_cond_sample_dataset(args.config_path, args.ckpt_path,  args.batch_size, n_sample=2416)
